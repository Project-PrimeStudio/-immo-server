...
app.config['JWT_SECRET_KEY'] = os.environ.get('JWT_SECRET', 'immo-secret-key-2024')
...
def seed_data():
    if Apartment.query.count() > 0:
        return
    samples = [
        Apartment(title="Bel appartement 3 pieces renove - Rivoli",
                  ...
                  rooms=3, surface=75,
                  description="Magnifique appartement au coeur de Paris, entierement renove, lumineux."),
        Apartment(title="Studio moderne - Le Marais",
                  ...
                  rooms=1, surface=32,
                  description="Studio moderne dans le quartier du Marais."),
        ...
        Apartment(title="F2 lumineux proche Part-Dieu",
                  ...
                  rooms=2, surface=48,
                  description="Appartement F2 tres lumineux proche de la gare Part-Dieu."),
        Apartment(title="Villa vue mer avec piscine",
                  ...
                  rooms=6, surface=200,
                  description="Villa avec vue mer et piscine privee sur la Corniche."),
        Apartment(title="T3 centre-ville - Nice",
                  ...
                  rooms=3, surface=65,
                  description="T3 lumineux en plein centre de Nice, 5 minutes de la Promenade."),
    ]
    for apt in samples:
        db.session.add(apt)
    db.session.commit()
    print("Donnees de demonstration ajoutees")

# ── CRITIQUE : s execute avec Gunicorn ET en direct ──
